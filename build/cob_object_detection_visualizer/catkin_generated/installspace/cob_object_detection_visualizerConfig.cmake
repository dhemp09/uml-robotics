...
if(NOT "/usr/include;/usr/include/opencv;/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include/ni;/usr/include/vtk-5.8 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cob_object_detection_visualizer' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dan/dan_ws/install/${idir}'.  Ask the maintainer 'Richard Bormann <richard.bormann@ipa.fraunhofer.de>' to fix it.")
    endif()
